...
var BasicComponent = (function () {
    ...
    BasicComponent.prototype.selfRender = function () {
        ...
        var element = isTextEditor ? atom.textEditors.build({ mini: this.mini }).element : document.createElement(this._tagName);
        if (isTextEditor) {
            if (this.mini) {
...
var AtomEditorElement = (function (_super) {
    ...
    function AtomEditorElement(text, _onchange) {
        ...
        this._onchange = _onchange;
        this.mini = true;
        this.didChangeActionWithContext = function () { return _this.didChangeAction(); };
    ...
    AtomEditorElement.prototype.didChangeAction = function () {
    ...
    AtomEditorElement.prototype.getValue = function () {
        return getModel(this.ui()).getText();
    };
